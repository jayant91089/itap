  ...
  #############################################################################
  ##
  ##  PackageInfo.g for the package `itap'                     Jayant Apte
  ##                                                                John Walsh
  ##
  ...
  ##  one line.
  Subtitle := "Information Theoretic Achievability Prover",
  ...
  PackageWWWHome :="http://www.ece.drexel.edu/walsh/aspitrg/itap/",
  ...
  # utilities.",
  AbstractHTML :=
    "The <span class=\"pkgname\">itap</span> Infrmation Theoretic Achievability Prover",
  PackageDoc := rec(
    # use same as in GAP
    BookName  := "itap",
    ...
    LongTitle := "Informtion Theoretic Achievability Prover",
  ),
  ...
  PackageDoc := rec(
    ...
    PDFFile   := "doc/manual.pdf",
    SixFile   := "doc/manual.six",
    LongTitle := "Information Theoretic Achievability Prover",
    Autoload  := false
  ),
